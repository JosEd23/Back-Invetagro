...
const getTemplete = (nombres, apellidos, token)=>{
    return  `
    <style type="text/css">
    img {
        max-width: 600px;
                      ...
                      <table cellspacing="0" cellpadding="0" class="force-full-width">
                        ...
                        <tr>
                          <td style="font-size:16px; font-weight: 400; text-align:center; padding: 0 75px; color: black" class="w320 mobile-spacing">
                            ...
                            <p style="opacity: 0.7;">Hola <b> ${nombres} ${apellidos} </b>, para restablecer su contraseña
                              haz clic en el botón <b>Restablecer</b> que
